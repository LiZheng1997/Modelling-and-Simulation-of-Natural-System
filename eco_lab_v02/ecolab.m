...
%nr - initial number of rabbit agents 兔子初始数量

%nf - initial number of fox agents 狐狸初始数量

%nsteps - number of iterations required 迭代次数


%全局变量
%definition of global variables:
%N_IT - current iteration number 当前迭代次数
...
%create_environment.m)
    ...
    [agent]=create_agents(nr,nf);       %create nr rabbit and nf fox agents and places them in a cell array called 'agents'，创建兔子、狐狸
